...
curl -sSf --retry 3 "https://geo.abs.gov.au/arcgis/rest/services/ASGS2021/LGA/MapServer/0/query?where=lga_name_2021+in+('Maribyrnong','Moonee+Valley')+and+state_code_2021='2'&outFields=lga_code_2021,lga_name_2021&outSR=4326&f=geojson" -o lga.geojson
# SA1s intersecting the study bbox (filtered to LGAs in 02_build.py)
curl -sSf --retry 3 "https://geo.abs.gov.au/arcgis/rest/services/ASGS2021/SA1/MapServer/0/query?geometry=144.835,-37.83,144.945,-37.705&geometryType=esriGeometryEnvelope&inSR=4326&spatialRel=esriSpatialRelIntersects&outFields=sa1_code_2021,sa2_name_2021,sa3_name_2021,area_albers_sqkm&outSR=4326&f=geojson&resultRecordCount=2000" -o sa1_bbox.geojson
# Census 2021 GCP DataPack, SA1, Victoria (~100 MB)
curl -sSfL --retry 3 -A "Mozilla/5.0" "https://www.abs.gov.au/census/find-census-data/datapacks/download/2021_GCP_SA1_for_VIC_short-header.zip" -o gcp.zip
